...
_print_int:
    ...
    adrp    x0, printInt      // Load address of format string
    add     x0, x0, printInt
...
print_nl:
    ...
    // Prepare arguments for printf
    adrp    x0, printNewline   // Load address of newline format string
    add     x0, x0, printNewline
...
print_string:
    ...
    adrp    x0, printString    // Load address of string format string
    add     x0, x0, printString
...
dump_regs:
    ...
    // Save all general-purpose registers x0-x28 to a safe area (high sets)
    ...
    adrp    x0, dump_regs_string
    add     x0, x0, :lo12:dump_regs_string
    ...
    adrp    x0, dump_regs_string2
    add     x0, x0, :lo12:dump_regs_string2
    ...
    adrp    x0, dump_regs_string3
    add     x0, x0, :lo12:dump_regs_string3
    ...
    adrp    x0, :pg_hi21:dump_regs_string4
    add     x0, x0, :lo12:dump_regs_string4
